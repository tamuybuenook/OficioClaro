...
import { Admin, AdminData, IpcAdmin, SimplePage } from '@/components/features/admin/admin-placeholders'
...
export function AppShell({ jobs, profile, paymentDetails, customers, subscription, trades }: AppShellProps) {
